...
if buy_sell_robot_j==1  % if the order is a buy 
    price_robot_j=best_bid; % set the price at least 1 tick lower than the best ask, ?what is min_price
   
else
    price_robot_j=best_ask; % if the order is a sell order, set the price at least 1 ticker higher than the best bid, ?what is max_price
